...
namespace SmartHR.DataApi.Controllers.api
{
    ...
    public class SectionsController : ControllerBase
    {
        ...
        /*
         * Custom to get section of an employee
         * 
         * */
        [HttpGet("Employee/{id}")]
        public async Task<ActionResult<Section>> GetEmployeeSection(int id)
        {
            var emp = await _context.Employees.Include(x => x.Section).FirstOrDefaultAsync(x => x.EmployeeId == id);
